...
const STATUS_META: Record<string, { label: string; cls: string }> = {
  active: { label: "구독 중", cls: "bg-green-100 text-green-700" },
  trialing: { label: "체험 중", cls: "bg-blue-100 text-blue-700" },
  past_due: { label: "결제 실패", cls: "bg-red-100 text-red-700" },
  canceled: { label: "해지됨", cls: "bg-gray-100 text-gray-600" },
  none: { label: "미구독", cls: "bg-gray-100 text-gray-600" },
};
  ...
  return (
    <div className="rounded-xl border border-surface-border bg-surface-card p-6 shadow-sm">
      <div className="flex items-center justify-between mb-1">
        <h2 className="text-base font-semibold text-gray-900">플랜 & 결제</h2>
      ...
      <div className="rounded-lg border border-surface-border p-4 mb-4">
        <div className="flex items-baseline justify-between">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">월 구독 · 부가세 별도</p>
          </div>
