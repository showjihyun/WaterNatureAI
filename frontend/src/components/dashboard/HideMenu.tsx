  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        aria-expanded={open}
        title="관심없음 (추천에서 숨기기)"
        className="inline-flex h-9 w-9 items-center justify-center rounded-lg text-ink-400 transition-colors hover:bg-surface-muted hover:text-ink-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-1 focus-visible:ring-primary-500"
      >
