  ...
  return (
    <div className="mb-6 rounded-xl border border-amber-200 bg-amber-50/70 p-4">
      <div className="mb-2.5 flex items-center gap-2">
        ...
        <span className="ml-1 text-xs text-amber-700/80">관심·진행 공고의 마감이 가까워요</span>
      </div>
            ...
            >
              ...
              {sourceUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="shrink-0 rounded-lg px-2 py-1 text-xs font-semibold text-amber-800 hover:bg-amber-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500"
                >
                  원문
                </a>
              )}
